...
ACLOCAL = ${SHELL} /cygdrive/d/libevent-2.0.20-stable/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /cygdrive/d/libevent-2.0.20-stable/missing --run autoconf
AUTOHEADER = ${SHELL} /cygdrive/d/libevent-2.0.20-stable/missing --run autoheader
AUTOMAKE = ${SHELL} /cygdrive/d/libevent-2.0.20-stable/missing --run automake-1.11
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /cygdrive/d/libevent-2.0.20-stable/missing --run makeinfo
MANIFEST_TOOL = :
...
ZLIB_LIBS = -lz 
abs_builddir = /cygdrive/d/libevent-2.0.20-stable
abs_srcdir = /cygdrive/d/libevent-2.0.20-stable
abs_top_builddir = /cygdrive/d/libevent-2.0.20-stable
abs_top_srcdir = /cygdrive/d/libevent-2.0.20-stable
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
acx_pthread_config = 
...
install_sh = ${SHELL} /cygdrive/d/libevent-2.0.20-stable/install-sh
